...
<div class="pt-2 mb-2">
  <h1 class="!border-none !mb-0 text-3xl font-bold">31｜'.gitignore' 规范：坚决不进版本库的文件</h1>
...
<div class="pt-2 mb-2">
  <h1 class="!border-none !mb-0 text-3xl font-bold">32｜GitHub 安全底线：严禁提交这些！</h1>
</div>
...
<div class="p-3 bg-blue-500/10 border border-blue-500/20 text-xs rounded-xl text-center flex items-center justify-center gap-2 text-blue-300">
...
<div class="pt-2 mb-2">
  <h1 class="!border-none !mb-0 text-3xl font-bold">33｜常用 Git 命令高频速查宝典</h1>
...
<div class="pt-2 mb-2">
  <h1 class="!border-none !mb-0 text-3xl font-bold">34｜从 GitHub 消费者到开源协作者</h1>
  <p class="text-xs text-gray-400 mt-1">从单兵作战到规范协同，开启现代软件工程研发闭环</p>
</div>

<div class="my-auto space-y-4">

<div class="p-4 bg-gray-50/80 border border-gray-200 rounded-2xl shadow-xs">

  <div class="grid grid-cols-4 gap-2.5 text-xs">
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-blue-100 text-blue-600 font-bold flex items-center justify-center text-[11px] shrink-0">1</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">甄选项目</div>
        <div class="text-[10px] text-gray-400">评估维护与协议</div>
      </div>
    </div>
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-blue-100 text-blue-600 font-bold flex items-center justify-center text-[11px] shrink-0">2</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">Clone / Fork</div>
        <div class="text-[10px] text-gray-400">拉取本地跑通</div>
      </div>
    </div>
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-emerald-100 text-emerald-600 font-bold flex items-center justify-center text-[11px] shrink-0">3</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">创建 Branch</div>
        <div class="text-[10px] text-gray-400">特性隔离保主干</div>
      </div>
    </div>
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-emerald-100 text-emerald-600 font-bold flex items-center justify-center text-[11px] shrink-0">4</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">原子化提交</div>
        <div class="text-[10px] text-gray-400">暂存筛选规范提交</div>
      </div>
    </div>
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-purple-100 text-purple-600 font-bold flex items-center justify-center text-[11px] shrink-0">5</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">Push 远端</div>
        <div class="text-[10px] text-gray-400">同步至个人云端</div>
      </div>
    </div>
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-purple-100 text-purple-600 font-bold flex items-center justify-center text-[11px] shrink-0">6</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">发起 PR</div>
        <div class="text-[10px] text-gray-400">详述背景与收益</div>
      </div>
    </div>
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-amber-100 text-amber-600 font-bold flex items-center justify-center text-[11px] shrink-0">7</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">Code Review</div>
        <div class="text-[10px] text-gray-400">同行评审多轮迭代</div>
      </div>
    </div>
    <div class="p-2.5 bg-white border border-gray-200 rounded-xl shadow-xs flex items-center gap-2">
      <div class="w-5 h-5 rounded-full bg-blue-100 text-blue-600 font-bold flex items-center justify-center text-[11px] shrink-0">8</div>
      <div>
        <div class="font-bold text-gray-800 text-[11px]">Merge 主干</div>
        <div class="text-[10px] text-gray-400">合入发布交付价值</div>
      </div>
    </div>
  </div>
</div>
...
<div class="text-center space-y-1.5 pt-1">
  <div class="text-xl font-serif italic text-blue-600">
